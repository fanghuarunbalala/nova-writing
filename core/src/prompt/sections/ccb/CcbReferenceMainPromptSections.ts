...
export class CcbReferenceIntroPromptSection extends PromptSection {
  constructor() {
    super({
      id: "ccb.reference.intro",
      version: "1.0.0",
      label: "CCB Reference: Intro",
    });
  }
...
export class CcbReferenceSystemPromptSection extends PromptSection {
  constructor() {
    super({
      id: "ccb.reference.system",
      version: "1.0.0",
      label: "CCB Reference: System",
    });
  }
...
export class CcbReferenceDoingTasksPromptSection extends PromptSection {
  constructor() {
    super({
      id: "ccb.reference.doing-tasks",
      version: "1.0.0",
      label: "CCB Reference: Doing Tasks",
    });
  }
...
export class CcbReferenceActionsPromptSection extends PromptSection {
  constructor() {
    super({
      id: "ccb.reference.actions",
      version: "1.0.0",
      label: "CCB Reference: Actions",
    });
  }
...
export class CcbReferenceUsingYourToolsPromptSection extends PromptSection {
  constructor() {
    super({
      id: "ccb.reference.using-tools",
      version: "1.0.0",
      label: "CCB Reference: Using Your Tools",
    });
  }
...
export class CcbReferenceCommunicationStylePromptSection extends PromptSection {
  constructor() {
    super({
      id: "ccb.reference.communication-style",
      version: "1.0.0",
      label: "CCB Reference: Communication Style",
    });
  }
