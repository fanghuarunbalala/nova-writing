/**
 * Novel 创作核心层 Prompt Section（doing-tasks / craft / worldbuilding）。
 * Novel creative-core prompt sections (doing-tasks / craft / worldbuilding).
 *
...
export class NovelDoingTasksPromptSection extends PromptSection {
  ...
  override render(): string {
    return [
      ...
      "",
      "- 作者给出偏好（节奏偏好、禁用梗、风格要求）时，用 Write 写入小说全局约束文件（NOVEL.md）持久保存，后续遵循。",
    ].join("\n");
  }
}
