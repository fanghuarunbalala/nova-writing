...
const references = [
  ...
  "prompt-assembly-smoke.mjs",
  "runtime-nudge-provider-call-receipt-smoke.mjs",
  "runtime-policy-nudge-effect-execution-smoke.mjs",
  "runtime-nudge-event-bridge-smoke.mjs",
  "runtime-nudge-store-v2-smoke.mjs",
